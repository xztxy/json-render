...
json-render also supports `$item` and `$index` expressions for lists, two-way binding via `statePath`, and conditional props. See [Data Binding](/docs/data-binding) for the full reference.
